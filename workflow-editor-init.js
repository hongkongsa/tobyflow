...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Initialize AuthManager first (must be before StorageSettings to prevent local owner discard)
